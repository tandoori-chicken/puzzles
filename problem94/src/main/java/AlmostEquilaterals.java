...
public class AlmostEquilaterals {
    ...
    //Problem at https://projecteuler.net/problem=94
    ...
    public static void main(String[] args) {
        ...
        long ctr=0;
        //b=a+1
        for(long a=2;a<=lim;a++)
        {
            long testSquare = (3*a+1)*(a-1);
            if(testSquare%4!=0)
                continue;
            testSquare/=4;
            if(!isPerfectSquare(testSquare))
                continue;
            long sqrt = (long)Math.sqrt(testSquare);
            long areaTimes2 = (a-1)*sqrt;
            if(areaTimes2%2!=0)
                continue;
...
//            System.out.println(a+" "+(a-1));
    ...
    //Below code from http://stackoverflow.com/questions/295579/fastest-way-to-determine-if-an-integers-square-root-is-an-integer
